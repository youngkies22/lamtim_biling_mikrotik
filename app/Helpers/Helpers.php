...
class Helpers
{
  public static function appClasses()
  {
    ...
    // default data array
    $DefaultData = [
      'myLayout' => 'horizontal', #horizontal #vertical
    ...
    $allOptions = [
      // 'myLayout' => ['horizontal', 'vertical', 'blank', 'front'],
      'myLayout' => ['horizontal', 'blank', 'front'],
  ...
  public static function getOlt()
  {
    return Lamtim_olt::where('isActive', 1)->get();
  }
  public static function getOdc()
  {
    return Lamtim_odc::get();
  }
  public static function getOdp()
  {
    return Lamtim_odp::get();
  }

  public static function generateSignature($path, $verb, $token, $timestamp, $body, $secret)
  {
    $payload = "path=$path&verb=$verb&token=Bearer $token&timestamp=$timestamp&body=$body";
    $signPayload = hash_hmac('sha512', $payload, $secret, true); // SNAP BI pakai SHA512 sha512 sha256
    return base64_encode($signPayload);
  }

  /**
   * PAKET DAN KATEGORI INTERNET
   */
  public static function getKategori()
  {
    return Lamtim_kategori::where('isActive', 1)->get();
  }
  public static function getPaket()
  {
    return Lamtim_paket::where('isActive', 1)->get();
  }
  public static function getPaketGrouped()
  {
    return Lamtim_paket::where('isActive', 1)->get()->groupBy('idKategori')->toArray();
  }
  public static function getArea()
  {
    return Lamtim_area::select('id', 'name', 'idKel')->get();
  }

  /**
   * MIKROTIK
   */
  public static function getMikrotik()
  {
    return Lamtim_mikrotik::where('isActive', 1)->get();
  }
}
