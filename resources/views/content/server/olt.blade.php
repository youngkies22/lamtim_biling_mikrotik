...
<script>
  let table;
              ...
              <div class="dropdown">
                ...
                <div class="dropdown-menu">
                  <a class="dropdown-item fw-bold btn-edit" href="javascript:void(0);"
                    ...
                    data-ip="${row.ip}" data-sfp="${row.sfp}" data-port="${row.port}" data-isactive="${row.isActive}">
    ...
    $("div.head-label").html('<h5 class="card-title mb-0">Data OLT</h5>');
    $('#form-add-new-record').on('submit', function (e) {
          ...
          const url = recordId
            ? `/olt/${recordId}`   // Untuk edit (PUT)
            : `/olt`;              // Untuk tambah baru (POST)
          const method = 'POST';
    ...
    $(document).on("click", ".btn-edit", function () {
      ...
      form.querySelector('[name="sfp"]').value = sfp;
    ...
    <form class="add-new-record pt-0 row g-3" id="form-add-new-record" onsubmit="return false">
      ...
      <div class="col-sm-12">
        <div class="input-group input-group-merge">
          ...
          <div class="form-floating form-floating-outline">
            <input type="text" class="form-control dt-date" id="ip" name="ip" autocomplete="off" />
      ...
      <div class="col-sm-12">
        <div class="input-group input-group-merge">
          ...
          <div class="form-floating form-floating-outline">
            ...
            <label for="basicSalary">PORT AKSES</label>
          </div>
        </div>
      </div>
      <div class="col-sm-12">
        <div class="input-group input-group-merge">
          <span id="basicSalary2" class="input-group-text"><i class='mdi mdi-usb-port'></i></span>
          <div class="form-floating form-floating-outline">
            <input type="number" id="sfp" name="sfp" class="form-control " autocomplete="off" />
            <label for="basicSalary">JUMLAH SFP</label>
          </div>
        </div>
      </div>
      <div class="col-sm-12">
