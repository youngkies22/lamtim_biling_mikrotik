...
@section('title', 'Data Kategori Internet')
...
<script>
  let table;
              ...
              <div class="dropdown">
                ...
                <div class="dropdown-menu">
                  <a class="dropdown-item fw-bold btn-edit" href="javascript:void(0);"
                    data-id="${data}" data-nama="${row.nama}" data-description="${row.description}" data-isactive="${row.isActive}">
    ...
    $('#form-add-new-record').on('submit', function (e) {
          ...
          const url = recordId
            ? `/kategori/${recordId}`   // Untuk edit (PUT)
            : `/kategori`;              // Untuk tambah baru (POST)
          const method = 'POST';
