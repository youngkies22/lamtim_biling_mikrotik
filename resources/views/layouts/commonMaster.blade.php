...
<head>
  ...
  {{-- Include Global Loading CSS --}}
  <link rel="stylesheet" href="{{ asset('assets/css/global-loading.css') }}" />
...
<body>
  ...
  {{-- Include Global Loading JS - Load early but after body --}}
  <script src="{{ asset('assets/js/global-loading.js') }}"></script>
  <!-- Layout Content -->
  @yield('layoutContent')
  <!--/ Layout Content -->
